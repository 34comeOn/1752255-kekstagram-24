...
for (let objectsAmount = 0; objectsAmount <= 24; objectsAmount ++) {
  descriptionsId[objectsAmount] = objectsAmount + 1;
}
...
for (let index = 0; index <= 24; index++) {
  ...
  const generateObjects = () =>
    ({
      id: descriptionsId[index],
      url: `photos/${descriptionsId[index]}.jpg`,
      description: DESCRIPTIONS[_.random(0, DESCRIPTIONS.length - 1)],
      likes: _.random(15, 200),
      comments: commentsArray,
    });

  arrayOfObjects[index] = generateObjects();
}
